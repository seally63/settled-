      ...
      <ThemedView style={styles.container}>
        ...
        >
          ...
          <View style={[styles.iconCircle, { backgroundColor: '#EEF2FF' }]}>
            <Ionicons name="home" size={28} color={TINT} />
          </View>

          <Spacer height={16} />

          <ThemedText style={styles.title}>Create Homeowner Account</ThemedText>
          <ThemedText style={styles.subtitle}>
            Get started finding trusted tradespeople
          </ThemedText>
